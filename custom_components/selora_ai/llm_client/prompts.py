...
def _tool_strategy_recipe() -> str:
    ...
    return (
        ...
        "also resolves a named scene to its real `scene.*` entity_id with "
        "domain='scene'), `find_entities_by_area`, `get_device_triggers` "
        "(device button/press triggers) — not broad listings.\n"
